...
class IssueCommentEventTest(unittest.TestCase):
    ...
    def test_legacy_oz_review_command_on_pr_does_not_route_to_review(self) -> None:
        decision = route_event(
            "issue_comment",
            {
                "action": "created",
...
class PullRequestReviewCommentTest(unittest.TestCase):
    ...
    def test_legacy_oz_review_command_on_review_comment_does_not_route_to_review(self) -> None:
        decision = route_event(
            "pull_request_review_comment",
            {
                "action": "created",
